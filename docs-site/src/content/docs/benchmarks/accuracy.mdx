...
The gate below is **pinned to the test threshold** (regenerated from the source on
every build):

| Sequence | Gate (ATE) | Reference (published, keyframe) |
|---|---|---|
| EuRoC V1_01_easy | **< {bench.euroc_v101_ate_gate_m} m** | OpenVINS ~0.05–0.06 m · VINS-Fusion ~0.08 m |
