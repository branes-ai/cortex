...
The measurements above come from the *synthetic* probe — a hand-built correlated
...
It writes `augmentation.json` and renders the **before/after covariance heatmap
