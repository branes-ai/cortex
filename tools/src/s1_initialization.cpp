...
//
// s1_initialization — study stage in isolation: Initialization (static & dynamic bootstrap) (scaffold).
//
...
int main(int argc, char** argv) {
    ...
    return branes::tools::run_scaffold(argc, argv, branes::tools::kS1, &pl);
}
