...
// the State vector, the covariance policies (full and square-root), the IMU
// Propagator (mean + covariance), the StateHelper (clone augmentation,
// marginalization, EKF update), and the CameraUpdater (feature
// triangulation + null-space MSCKF update).
